        ...
        return (
            ...
            >
                ...
                {unreadCount !== null && unreadCount !== undefined && unreadCount > 0 &&
                  <span style={{right: 5, top: 5, position: 'absolute', backgroundColor: '#FF0000', width: 10, height: 10, borderRadius: 6, fontSize: 0, color: '#FF0000'}}>
                    {unreadCount}
                  </span>
                }
            </li>
...
class Tabs extends React.Component {
    ...
    render() {
        let {children, contentClass, tabsClass, style, segmented, isFull} = this.props;
        const collapseTabs =
        ...
        return (
            ...
            >
                ...
                <div className={cnames("tab-content", contentClass)} style={isFull ? {height: '100%', backgroundColor: 'transparent'} : null}>
                    {activeContent}
                </div>
            </div>
        );
