...
class AccountWalletActivity extends React.Component {
    static propTypes = {
...
AccountWalletActivity = BindToChainState(AccountWalletActivity);
...
export {AccountWalletActivity, TransactionWrapper};
