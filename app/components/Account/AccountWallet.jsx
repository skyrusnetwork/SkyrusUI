...
import {AccountWalletActivity} from "./AccountWalletActivity";
import AccountWalletBalance from "./AccountWalletBalance";
...
class AccountOverview extends React.Component {
    ...
    _initPsContainer() {
        ...
        if( this.refs.appTables && this.psInit ) {
          let appTables = this.refs.appTables;
          if( appTables ) {
            Ps.initialize(appTables);
            this.psInit = false;
          }
        }
    }
    ...
    render() {
        ...
        return (
          <div className="grid-content app-tables no-overflow ps-container" ref="appTables" style={{paddingLeft: 10, paddingRight: 10}}>
                          ...
                          >
                              ...
                              >
                                  <div className="header-selector">
                                      ...
                                      <div className="selector inline-block" style = {{display:"none"}}>
                                          <div
