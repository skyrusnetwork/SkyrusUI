...
class DepositWithdrawAssetSelector extends React.Component {
    ...
    render() {
        ...
        let getCoinOption = item => {
            ...
            if (!idMap[backedCoin] && backedCoin && gateway) {
                ...
                return {
                    ...
                    issuer: item.issuerId || "1.2.30" //Fall back to base
                };
            } else {
                return null;
            }
        ...
        if (!(this.props.includeBTS === false) && this.props.usageContext == 'withdraw') {
            coinArr.push({id: "SKX", label: "SKX", gateway: ""});
        }
