...
class LoginSelector extends React.Component {
    ...
    render() {
        let dashBack = require('../assets/icons/dash-back.png');
        ...
        return (
            <div className="grid-block align-center" id="accountForm" style={{backgroundRepeat: 'no-repeat', backgroundSize: 'cover',backgroundPosition: 'center', backgroundImage: "url(" + dashBack + ")"}}>
                <div className="grid-block shrink vertical">
                    <div className="grid-content shrink text-center account-creation">
                        ...
                        <div className="grid-block account-login-options" style={{margin:"20px 0px"}}>

                            <span
                                className="button hollow primary" style={{width:"100%"}}
                                onClick={() => {
                            ...
                            <Link
                                id="account_login_button" style={{width:"100%"}}
                        ...
                        <div className="additional-account-options" style={{display: "none"}}>
