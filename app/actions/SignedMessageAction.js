...
const MSG_HEAD = "-----BEGIN SKYRUS SIGNED MESSAGE-----";
const MSG_META = "-----BEGIN META-----";
const MSG_SIGNATURE = "-----BEGIN SIGNATURE-----";
const MSG_FOOT = "-----END SKYRUS SIGNED MESSAGE-----";
...
class SignedMessageAction {
     ...
     *                      block : Current last irreversible block of the skyrus blockchain
