...
const CORE_ASSET = "SKX"; // Setting this to BTS to prevent loading issues when used with BTS chain which is the most usual case currently
...
class SettingsStore {
    ...
    _getDefaultChoices() {
        return {
            ...
            themes: ["lightTheme", "midnightTheme"],
            passwordLogin: [
